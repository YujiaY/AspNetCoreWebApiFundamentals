...
namespace CityInfo_Dev.Controllers
{
    ...
    public class FilesController : ControllerBase
    {
        ...
        public ActionResult GetFile(string fileId)
        {
            ...
            // demo code
            var pathToFile1 = "Testing Document-1.pdf";
            var pathToFile2 = "Testing Document-2.pdf";
            var paths = new[] { pathToFile1, pathToFile2 };

            // check whether the file exists
            var pathToFile = paths.FirstOrDefault(p => p.Contains(fileId));
        ...
        public async Task<ActionResult> CreateFile(IFormFile file)
        {
            ...
            var path2 = Directory.GetDirectoryRoot(Directory.GetCurrentDirectory());
            var path3 = Path.GetFullPath(path1);
            DirectoryInfo? path4 = Directory.GetParent(Directory.GetCurrentDirectory());
